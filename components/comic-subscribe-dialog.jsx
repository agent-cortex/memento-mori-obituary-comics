...
export function ComicSubscribeDialog({ comic }) {
  ...
  return (
    <section className="reader-subscribe-cta" aria-labelledby={headingId}>
      ...
      <Dialog onOpenChange={(open) => open && trackActivity("newsletter_dialog_opened", { source: "reader_dialog", comic_slug: comic.slug })}>
        ...
        <DialogContent className="newsletter-dialog">
          ...
          <SubstackForm source="reader_dialog" comicSlug={comic.slug} />
        </DialogContent>
      </Dialog>
    </section>
  );
