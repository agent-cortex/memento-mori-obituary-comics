...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | SOLRAD | https://solrad.co/submissions | `docs/seo/pitches/01-solrad-obituary-comics-essay.md` | Pitch: Obituary comics as source-backed visual biography | https://www.finalnotes.page/what-are-obituary-comics/ | SOLRAD explicitly accepts comics criticism, essays, interviews, and reported nonfiction around comics arts outside the mainstream. |
| 2 | The Comics Journal | https://www.tcj.com/faq/ | `docs/seo/pitches/02-tcj-submission-inquiry.md` | Submission Inquiry: obituary comics as a comics form | https://www.finalnotes.page/what-are-obituary-comics/ | TCJ is a high-relevance comics criticism publication; their FAQ gives a specific submission inquiry email pattern. |
| 3 | Beyond the Dash | https://beyondthedash.com/about/ | `docs/seo/pitches/03-beyond-the-dash-visual-life-story.md` | Guest post pitch: How to turn an obituary into a visual life story | https://www.finalnotes.page/how-to-write-an-obituary-story/ | Beyond the Dash is directly about memorable obituary writing and life stories and says it accepts guest blog ideas. |
| 4 | Graphic Medicine | https://www.graphicmedicine.org/get-involved/ | `docs/seo/pitches/04-graphic-medicine-resource-review.md` | Resource/review suggestion: visual obituaries and mortality comics | https://www.finalnotes.page/educators-libraries/ | Graphic Medicine explicitly routes review interest to its reviews editor, and its audience is a strong fit for grief, illness, death, and comics pedagogy. |
| 5 | Bradley University Graphic Medicine guide | https://bradley.libguides.com/graphicmedicine/start | `docs/seo/pitches/05-bradley-graphic-medicine-libguide.md` | Resource suggestion for graphic medicine / grief comics | https://www.finalnotes.page/educators-libraries/ | The guide is an exact topical fit for comics, illness narratives, and classroom/library resource use. |
| 6 | UCLA Comics Studies guide | https://guides.library.ucla.edu/comics-studies | `docs/seo/pitches/06-ucla-comics-studies-libguide.md` | Resource suggestion: visual biography examples for comics studies | https://www.finalnotes.page/educators-libraries/ | Strong institutional resource page; useful if framed as a teaching/citation example rather than promotion. |
| 7 | Comics Beat | https://www.comicsbeat.com/contact/ | `docs/seo/pitches/07-comics-beat-news-tip.md` | News tip: source-backed obituary comics archive | https://www.finalnotes.page/press/ | Useful for a short news tip after the higher-fit essay/resource pitches are sent. |
...
| 11 | Grief Collective | https://griefcollective.com/contact | `docs/seo/pitches/09-grief-collective-guest-interview.md` | Guest post or interview idea: visual obituary stories and grief writing | https://www.finalnotes.page/how-to-write-an-obituary-story/ | Strong grief-writing fit and their guest/interview guidelines allow a short credit blurb linking to the author's site. |
| 12 | Family History Fanatics | https://www.familyhistoryfanatics.com/contact | `docs/seo/pitches/14-family-history-fanatics-visual-story.md` | Resource idea: turning obituaries into visual family stories | https://www.finalnotes.page/how-to-write-an-obituary-story/ | Direct topical overlap with their obit-to-family-story writing challenge and genealogy writing audience. |
| 13 | Free UK Genealogy | https://www.freeukgenealogy.org.uk/contact/guest-post-2/ | `docs/seo/pitches/12-freeuk-genealogy-obit-to-story.md` | Guest post idea: From obituary record to family history story | https://www.finalnotes.page/how-to-write-an-obituary-story/ | Their guest-post guidance asks for practical family-history value; obituary records are a natural fit if handled as evidence-first genealogy. |
| 14 | TalkDeath | https://talkdeath.com/write-for-us/ | `docs/seo/pitches/10-talkdeath-visual-obituary-pitch.md` | Pitch: What visual obituaries can teach us about remembering the dead | https://www.finalnotes.page/how-to-write-an-obituary-story/ | High topical relevance to death, grief, death positivity, and art/history, but requires a human-written non-SEO essay. |
...
| 58 | NewspaperArchive | https://newspaperarchive.com/contactus/ | `docs/seo/pitches/56-newspaperarchive-obituary-vs-death-notice.md` | Resource suggestion for obituary, death notice, and funeral notice readers | https://www.finalnotes.page/obituary-vs-death-notice/ | Current newspaper-archive blog coverage directly compares the formats and has genealogy/search-reader overlap. |
| 59 | MERI | https://www.meri.org/contact | `docs/seo/pitches/57-meri-obituary-vs-death-notice-resource.md` | Supplemental death notice vs obituary resource | https://www.finalnotes.page/obituary-vs-death-notice/ | MERI publishes death-notice and obituary guidance for families connected to whole-body donation and memorial planning. |
...
| --- | --- | --- |
| Modern Loss | Their Submittable page showed no open calls on 2026-06-04, even though the publication remains a strong grief-writing fit. | Check weekly, then send the essay pitch when submissions reopen. |
