...
| P1 | Grief Collective | https://griefcollective.com/contact | Guest post or interview about visual obituary stories and grief writing. | https://www.finalnotes.page/how-to-write-an-obituary-story/ | obituary story writing guide |
...
| P1 | TalkDeath | https://talkdeath.com/write-for-us/ | Human-written death-positive essay about visual obituaries and memory. | https://www.finalnotes.page/how-to-write-an-obituary-story/ | obituary story writing guide |
...
| P1 | FamilySearch Research Wiki | https://www.familysearch.org/wiki/en/FamilySearch_Wiki:Submit_Wiki_Content | Compliant wiki/resource suggestion only where it materially improves a relevant obituary research page. | https://www.finalnotes.page/obituary-research-guide/ | obituary research guide |
...
| P2 | Funeral Basics | https://la.funeraldirectorslife.com/contact/ | Supplemental obituary/eulogy comparison for families preparing both written and spoken tributes. | https://www.finalnotes.page/obituary-vs-eulogy/ | obituary vs eulogy |
| P2 | Dignity Bereavement Support | https://www.dignitybereavementsupport.com/contact or homepage contact path | Supplemental obituary/eulogy comparison for bereavement-writing readers. | https://www.finalnotes.page/obituary-vs-eulogy/ | obituary vs eulogy |
...
| P1 | Legacy.com | https://www.legacy.com/contact/ or current help/editorial contact path | Neutral quote-checklist companion for readers comparing online and newspaper obituary pricing. | https://www.finalnotes.page/obituary-cost/ | obituary cost guide |
| P2 | Funeral.com | https://funeral.com/pages/contact-us or current editorial/contact path | Practical companion for digital and newspaper obituary cost readers. | https://www.finalnotes.page/obituary-cost/ | newspaper obituary cost guide |
| P2 | Trustworthy | https://www.trustworthy.com/contact or current editorial/contact path | Supplemental family checklist before approving a newspaper or funeral-home obituary quote. | https://www.finalnotes.page/obituary-cost/ | obituary cost checklist |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | Beyond the Dash | `docs/seo/pitches/03-beyond-the-dash-visual-life-story.md` | /how-to-write-an-obituary-story/ |  |  |  |  |  |
|  | SOLRAD | `docs/seo/pitches/01-solrad-obituary-comics-essay.md` | /what-are-obituary-comics/ |  |  |  |  |  |
|  | The Comics Journal | `docs/seo/pitches/02-tcj-submission-inquiry.md` | /what-are-obituary-comics/ |  |  |  |  |  |
|  | Graphic Medicine | `docs/seo/pitches/04-graphic-medicine-resource-review.md` | /educators-libraries/ |  |  |  |  |  |
...
|  | Remembering A Life | `docs/seo/pitches/08-remembering-a-life-tribute-article.md` | /how-to-write-an-obituary-story/ |  |  |  |  | Requires full human-written Word doc |
|  | Grief Collective | `docs/seo/pitches/09-grief-collective-guest-interview.md` | /how-to-write-an-obituary-story/ |  |  |  |  |  |
|  | TalkDeath | `docs/seo/pitches/10-talkdeath-visual-obituary-pitch.md` | /how-to-write-an-obituary-story/ |  |  |  |  | Human rewrite required; avoid SEO framing |
...
|  | Cyndi's List | `docs/seo/pitches/51-cyndis-list-obituary-research-guide.md` | /obituary-research-guide/ |  |  |  |  | Genealogy directory submission |
|  | FamilySearch Research Wiki | `docs/seo/pitches/52-familysearch-wiki-obituary-research-guide.md` | /obituary-research-guide/ |  |  |  |  | Wiki-compliance required |
...
|  | Funeral Basics | `docs/seo/pitches/61-funeral-basics-obituary-vs-eulogy.md` | /obituary-vs-eulogy/ |  |  |  |  | Eulogy and obituary explainer target |
|  | Dignity Bereavement Support | `docs/seo/pitches/62-dignity-bereavement-obituary-vs-eulogy.md` | /obituary-vs-eulogy/ |  |  |  |  | Bereavement-writing comparison target |
...
|  | Legacy.com | `docs/seo/pitches/90-legacy-obituary-cost-guide.md` | /obituary-cost/ |  |  |  |  | Obituary cost quote-checklist target |
|  | Funeral.com | `docs/seo/pitches/91-funeralcom-obituary-cost-guide.md` | /obituary-cost/ |  |  |  |  | Digital and newspaper obituary cost target |
|  | Trustworthy | `docs/seo/pitches/92-trustworthy-obituary-cost-guide.md` | /obituary-cost/ |  |  |  |  | End-of-life planning cost target |
